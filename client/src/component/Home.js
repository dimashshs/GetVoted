          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            {!this.state.elStarted & !this.state.elEnded ? (
              <div className="container-main-about">
                {/* about-admin */}
                <div className="about-admin-changed">
                  <div className="container-item_center-items_changed">
                    <div className="divOfhome">
                      <label className="label-home-changed">
                        Full Name{" "}
                        {errors.adminFName && <EMsg msg="*required" />}
                        <input
                          className="input-home-changed"
                          type="text"
                ...
                {/* about-election */}
                <div className="about-election-changed">
                  <div className="container-item_center-items_changed">
                    <div className="divOfhome">
                      <label className="label-home-changed">
                        Election Title{" "}
