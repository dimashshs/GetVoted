          ...
          {!this.state.isElStarted && !this.state.isElEnded ? (
            ...
            <>
              {this.state.currentVoter.isRegistered ? (
                ...
                <>
                  <div className="container-item_attention">
                    <center>
                      <p className="regLink">You're not registered. 
                      <Link
                        to="/Registration"
              ...
              <div className="container_main">
                <h2>Candidates</h2>
                <small className="small_g">Total candidates: {this.state.candidates.length}</small>
                {this.state.candidates.length < 1 ? (
                  <div className="container_item_attention">
