      ...
      <>
        ...
        {!this.state.isElStarted && !this.state.isElEnded ? (
          ...
          <>
           <h3>Registration</h3>
            <div className="">
              <center><p>Total registered voters: {this.state.voters.length}</p></center>
            </div>
            <div className="">
              <div className="con">
                <form>
            ...
            <div
              className="container-main table-container"
              style={{
            ...
            {this.state.isAdmin ? (
              <div className="container-main table-container">
  ...
  return (
    <>
      <div
        className={""}
      >
        <center><h3> Your Registered Info </h3> </center>
      </div>
      <div
        className={""}
      >
...
<div className="container"> 
  <center><h3 className="" style={{ borderTop: "1px solid" }}>List of voters</h3></center>
</div>
